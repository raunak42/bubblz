...
const flavorTextures = {
  lemonLime: "/labels/lemon-lime.svg",
  grape: "/labels/grape.svg",
  blackCherry: "/labels/cherry.svg",
  strawberryLemonade: "/labels/strawberry.svg",
  watermelon: "/labels/watermelon.svg",
};
